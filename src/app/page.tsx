...
import AIApiConfig from "@/components/AIApiConfig";
import ContentProcessor from "@/components/ContentProcessor";
import UsageAnalytics from "@/components/UsageAnalytics";
import TestingDashboard from "@/components/TestingDashboard";

export default function Home() {
  const [activeStep, setActiveStep] = useState<'profile' | 'apis' | 'process' | 'analytics' | 'testing'>('profile');
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">AI Content Replacer Pro</h1>
                <p className="text-sm text-gray-500">WordPress Plugin Dashboard</p>
              </div>
            </div>
        ...
        {/* Main Content */}
         <Tabs value={activeStep} onValueChange={(value) => setActiveStep(value as any)} className="space-y-6">
          <TabsList className="grid w-full grid-cols-5">
            ...
            <TabsTrigger value="apis">AI APIs</TabsTrigger>
            <TabsTrigger value="process">Content Processing</TabsTrigger>
